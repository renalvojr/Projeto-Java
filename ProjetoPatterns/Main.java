...
public class Main {
    ...
    // funções
    public static int retornarindice_projeto(int id, ArrayList<Projeto> arrayDeProjetos) {
        for (int ii = 0; ii < arrayDeProjetos.size(); ii++) {
            if (arrayDeProjetos.get(ii).idProjeto == id) {
                return ii;
            }
        }
        return -1;
    ...
    public static int retornarindice_atividade(int id, ArrayList<Atividade> arrayDeAtividades) {
        for (int ii = 0; ii < arrayDeAtividades.size(); ii++) {
            if (arrayDeAtividades.get(ii).idAtividade == id) {
                return ii;
            }
        }
        return -1;
                        ...
                        while (chave == 1) {
                            ...
                            if (tipoUsuarioLogado == 1 || tipoUsuarioLogado == 2 || tipoUsuarioLogado == 3
                                ...
                                if (escolha == 1) {
                                    ...
                                    if (escolha2 == 1) {
                                        ...
                                        int indicep = retornarindice_projeto(idProjetoEntrar, arrayDeProjetos);
                                        arrayDeProjetos.get(indicep).idProfissionais.add(idUsuarioLogado);
                                        System.out.println("Você entrou no projeto");

                                        // O mesmo aplicado para Atividade
                                    } else if (escolha2 == 2) {
                                        System.out.println("Digite o ID da atividade que deseja entrar");
                                        int idAtividadeEntrar = input.nextInt();

                                        int indicep = retornarindice_atividade(idAtividadeEntrar, arrayDeAtividades);
                                        arrayDeAtividades.get(indicep).idProfissionais.add(idUsuarioLogado);
                            ...
                            // Se for profissional ou pesquisador
                                ...
                                // Criando um projeto
                                    ...
                                    Dados dados = new Dados(descricaoProjeto, dataInicio, dataTermino);
                                    arrayDeAtividades.add(new Atividade(idProjeto, coordenador, dados));
                                    System.out.println(arrayDeAtividades.get(0).dados.descricao);
                                }
                                // Criando uma atividade
                                    ...
                                    Dados dados = new Dados(descricaoAtividade, dataInicio, dataTermino);
                                    arrayDeAtividades.add(new Atividade(idAtividade, responsavel, dados));
                                }
                                // Editar usuário
                                else if (escolha == 4) {
                                    ...
                                    for (int iii = 0; iii < arrayDeProjetos.size(); iii++) {
                                        ...
                                        if (idProjetoModificado == arrayDeProjetos.get(iii).idProjeto) {
                                            ...
                                            if (escolha2 == 1) {
                                                ...
                                                arrayDeProjetos
                                                        .get(indiceProjetoModificado).dados.descricao = novaDescricao;
                                                ...
                                                arrayDeProjetos
                                                        .get(indiceProjetoModificado).dados.dataInicio = novaDataInicio;
                                                ...
                                                arrayDeProjetos
                                                        .get(indiceProjetoModificado).dados.dataTermino = novaDataTermino;
                                                ...
                                                if (arrayDeProjetos.get(indiceProjetoModificado).dados.descricao
                                                        .isEmpty()) {
                                                    System.out
                                    ...
                                    for (int iii = 0; iii < arrayDeAtividades.size(); iii++) {
                                        if (idAtividadeModificada == arrayDeAtividades.get(iii).idAtividade) {
                                            ...
                                            if (escolha2 == 1) {
                                                ...
                                                String novaDescricao = input.nextLine();
                                                arrayDeAtividades
                                                        .get(indiceAtividadeModificada).dados.descricao = novaDescricao;
                                                System.out.println("Descrição modificada com sucesso");
                                                ...
                                                String novaDataInicio = input.nextLine();
                                                arrayDeAtividades
                                                        .get(indiceAtividadeModificada).dados.dataInicio = novaDataInicio;
                                                System.out.println("Data de início modificada com sucesso");
                                                ...
                                                String novaDataTermino = input.nextLine();
                                                arrayDeAtividades
                                                        .get(indiceAtividadeModificada).dados.dataTermino = novaDataTermino;
